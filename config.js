...
const SYMBOLS = [
  { key: "seven", label: "7️⃣", icon: "sym_seven", color: "#ff2d2d", multiplier: 50 },
  { key: "blossom", label: "🌸", icon: "sym_blossom", color: "#ff8fab", multiplier: 20 },
  { key: "hibiscus", label: "🌺", icon: "sym_hibiscus", color: "#ff4d6d", multiplier: 15 },
  { key: "grape", label: "🍇", icon: "sym_grape", color: "#9b5de5", multiplier: 10 },
  { key: "strawberry", label: "🍓", icon: "sym_strawberry", color: "#ff2d55", multiplier: 8 },
  { key: "cherry", label: "🍒", icon: "sym_cherry", color: "#e63946", multiplier: 6 },
  { key: "mushroom", label: "🍄", icon: "sym_mushroom", color: "#c77dff", multiplier: 4 },
];
